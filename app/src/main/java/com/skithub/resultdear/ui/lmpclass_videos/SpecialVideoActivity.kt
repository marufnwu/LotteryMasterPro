                    ...
                    if(response.isSuccessful && response.body()!=null){
                        ...
                        if(!lmpVideoResponse.error){
                            ...
                            lmpVideoResponse.lmpVideos?.let {
                                ...
                                if(facebook == null){
                                    if(!lmpVideoResponse.facebook.isNullOrEmpty()){
                                        binding.facebook.setOnClickListener {
                                            CommonMethod.openLink(this@SpecialVideoActivity, lmpVideoResponse.facebook)
                                        }
                                    }
                                }
                                ...
                                if(youtube == null){
                                    if(!lmpVideoResponse.youtube.isNullOrEmpty()){
                                        binding.youtube.setOnClickListener {
                                            CommonMethod.openLink(this@SpecialVideoActivity, lmpVideoResponse.youtube)
                                        }
                                    }
                                }
