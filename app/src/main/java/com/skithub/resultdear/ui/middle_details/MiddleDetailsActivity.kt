...
class MiddleDetailsActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityMiddleDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityMiddleDetailsBinding.inflate(layoutInflater)
    ...
    private fun noInternetDialog(til: String, msg: String) {
        ...
        val builder=AlertDialog.Builder(this@MiddleDetailsActivity)
            .setCancelable(false)
    ...
    private fun loadLotteryNumberList() {
        ...
        Coroutines.main {
            try {
                ...
                val response=viewModel.getMiddleListUsingLotteryNumber(lotteryNumber)
